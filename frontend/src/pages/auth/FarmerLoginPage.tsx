...
import { LogIn, Sparkles, AlertCircle, Phone, Lock } from 'lucide-react';
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 shadow-xl space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative">
              <input
                ...
                placeholder={language === 'mr' ? 'उदा. ९८७६५४३२१० किंवा farmer@pashusetu.gov.in' : 'e.g. 9876543210 or farmer@pashusetu.gov.in'}
          ...
          >
            ...
            <span>{isSubmitting ? t('verifying') : t('loginAsFarmer')}</span>
          </button>
        </form>
